...
const oAuthConfig: AuthConfig = { 
  ...
  redirectUri: 'http://localhost:4200/login',  // the url redirect after the usser is logged, it is the url that we provided in the oauth2 config on google console
